...
function ItemDetail ({id, name, price, description, img}) {
    ...
    return (
        <div className="ItemDetail" >
            ...
            {parentcount > 0 ? <div className='continuar'><Link className='terminar' to='/cart'>Terminar compra</Link> <Link className='seguirComprando' to='/' >Seguir comprando</Link> </div> : <ItemCount stock = '5' onAdd = {OnAdd} cartQuantity = {getItem(id)?.parentcount} initial = {1} />}
        </div>
